...
def page_shell(title: str, content: str, depth: int = 0) -> str:
...
"""
        ...
        page = page_shell(f"{lesson['title']} · {author['name']}", lesson_content, depth=2)
        ...
        page = page.replace('<body>', f"<body data-lesson='{lesson_meta}'>", 1)
